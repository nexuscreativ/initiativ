                ...
                <div class="row m-0 min-h-100vh items-center">
                    <div class="col col-12 col-md-6 pr-100 module-content">
                        <div class="ld-fancy-heading">
                            <h2 class="ld-fh-element mb-0/75em text-70 leading-0/8em font-medium text-black">Login to your
                                <span>account</span>
                            </h2>
                        </div>
                        <div class="ld-fancy-heading">
                            <p class="text-18 ld-fh-element">Welcome Back! Access Your Account and Get Started.</p>
                        </div>
                            ...
                            <div class="row m-0">
                                <div class="col col-md-6 p-0">
                                    <div class="ld-fancy-heading relative mb-10">
                                        <h6 class="ld-fh-element mb-0/5em inline-block relative text-black">Support</h6>
                                    </div>
                                    <div class="mb-10 ld-fancy-heading relative">
                                        <p class="ld-fh-element mb-0/5em inline-block relative text-16 leading-1/2em font-medium text-text">
                                            Need Help? Reach Out to Us.</p>
                                    </div>
                                    <div class="ld-fancy-heading relative mb-10">
                                        <p class="ld-fh-element mb-0/5em inline-block relative">
                                            <a href="mailto:support@1019initiative.ng"
                                                class="text-16 font-bold leading-1/2em text-black">support@1019initiative.ng
                                            </a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col col-md-6 p-0">
                                    ...
                                    <div class="ld-fancy-heading relative">
                                        <p class="ld-fh-element mb-0/5em inline-block relative">
                                            <a href="mailto:feedback@1019initiative.ng"
                                                class="text-16 font-bold leading-1/2em text-black">feedback@1019initiative.ng</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form method="post" class="lqd-cf-form"
                                    ...
                                    <p>
                                        ...
                                        <span class="lqd-form-control-wrap">
                                            <input
                                                class="border-black-20 text-black text-14 font-normal bg-transparent"
                                                type="password" name="password" size="40" aria-required="true"
