                ...
                <div class="row m-0 min-h-100vh items-center">
                    <div class="col col-12 col-md-6 pr-100 module-content">
                        <div class="ld-fancy-heading">
                            <h2 class="ld-fh-element mb-0/75em text-70 leading-0/8em font-medium text-black">Create new
                                <span>account.</span>
                            </h2>
                        </div>
                        <div class="ld-fancy-heading">
                            <p class="text-18 ld-fh-element">Be Part of Something Big. Join Our Community Today!.</p>
                        </div>
